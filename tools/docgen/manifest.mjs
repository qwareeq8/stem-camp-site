...
function sourceFor(entry) {
  // Printables are generated by tools/docgen/build_pystem.mjs straight to the PDF
  // build dir; they have no archive DOCX source and skip extract/render/build.
  if (entry.category === "Printable") return null;
...
function templateFor(entry) {
  if (entry.category === "Printable") return "static";
