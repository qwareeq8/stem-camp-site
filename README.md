...
public/files/           the 102 downloadable program PDFs (all generated by tools/docgen)
...
download them. The `public/files/` directory holds 77 PDFs: a student handout
and an instructor guide for each of the 24 graded stations across both camps and
each of the eight backup activities, each camp's packet, score sheets, and
signage, the master curriculum and operations guide, the printable reward and
competition kit, the staff setup and safety checklist, the Amazon procurement
