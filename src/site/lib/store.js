...
// admin edits back via an authenticated supabase-js upsert under Row Level
// Security. This module re-exports the stable component API (useCollection,
// useConfig, getCollection, setCollection, resetCollection, isOverridden,
// subscribe, SEED_DATA) so existing page imports from "./lib/store.js" keep
// working unchanged.
export {
  subscribe,
  getCollection,
